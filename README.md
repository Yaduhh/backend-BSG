...
```bash
# Health check
curl http://192.168.0.107:3000/api/health

# Server status
curl http://192.168.0.107:3000/api/status
```
...
# Get orders
curl http://192.168.0.107:3000/api/orders

# Create order
curl -X POST http://192.168.0.107:3000/api/orders \
...
- **Server Status**: `http://192.168.0.107:3000/api/status`
...
**Database Configuration:**
- `DB_HOST=192.168.0.107` - Host MySQL server
