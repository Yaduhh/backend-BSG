...
const leaderProfileRoutes = require('./routes/leaderProfile');
const adminKomplainRoutes = require('./routes/adminKomplain');
const leaderKomplainRoutes = require('./routes/leaderKomplain');
...
app.use('/api/user', deleteAccountRoutes);
