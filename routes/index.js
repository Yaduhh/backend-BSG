...
const leaderKomplainRoutes = require('./leaderKomplain');
const pengumumanRoutes = require('./pengumuman');
const omsetHarianRoutes = require('./omsetHarian');
...
router.use('/leader/komplain', leaderKomplainRoutes);
router.use('/pengumuman', pengumumanRoutes);
router.use('/omset-harian', omsetHarianRoutes);
