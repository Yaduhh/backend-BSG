...
const createDataTargetTable = async () => {
  try {
    console.log('🔄 Creating data_target table...');
    ...
    console.log('✅ Table data_target created successfully!');
    ...
    console.log('🎉 Data Target table setup completed!');
    
  } catch (error) {
    console.error('❌ Error creating data_target table:', error);
  } finally {
