        ...
        const fixedImages = images.map(img => {
          ...
          if (img.url) {
            ...
            if (fixedUrl.includes('192.168.30.116:3000')) {
              fixedUrl = fixedUrl.replace('http://192.168.30.116:3000', '');
          ...
          if (img.serverPath) {
            ...
            if (fixedServerPath.includes('192.168.30.116:3000')) {
              fixedServerPath = fixedServerPath.replace('http://192.168.30.116:3000', '');
