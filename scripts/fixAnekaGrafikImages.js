      ...
      try {
        ...
        const fixedImages = images.map(img => {
          ...
          if (img.url) {
            ...
            if (fixedUrl.includes('202.10.45.115:3000')) {
              fixedUrl = fixedUrl.replace('http://202.10.45.115:3000', '');
          ...
          if (img.serverPath) {
            ...
            if (fixedServerPath.includes('202.10.45.115:3000')) {
              fixedServerPath = fixedServerPath.replace('http://202.10.45.115:3000', '');
