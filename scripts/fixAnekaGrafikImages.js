      ...
      try {
        ...
        const fixedImages = images.map(img => {
          ...
          if (img.url) {
            ...
            if (fixedUrl.includes('172.20.10.10:3000')) {
              fixedUrl = fixedUrl.replace('http://172.20.10.10:3000', '');
          ...
          if (img.serverPath) {
            ...
            if (fixedServerPath.includes('172.20.10.10:3000')) {
              fixedServerPath = fixedServerPath.replace('http://172.20.10.10:3000', '');
